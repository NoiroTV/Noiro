...
export const ACCENTS: Accent[] = [
  { id: "noiro", label: "Noiro", base: "#d97706", bright: "#f59e0b", onAccent: "#0f0d0a" },
...
const KEY = "noiro.desktop.settings.v1";
const DEFAULTS: Settings = { accentID: "noiro", background: "warm", textScale: 1 };
  ...
  target.innerHTML = `
    <div class="settings-page">
      ...
      <section class="settings-section">
        ...
        <div class="settings-card">
          <div class="settings-row"><span>Version</span><span class="settings-sub">Noiro desktop preview</span></div>
          <div class="settings-row"><span>Website</span><a class="inline-link" href="https://vortexo.app" target="_blank" rel="noopener">vortexo.app</a></div>
        </div>
      </section>
    </div>`;
}
...
export function handleSettingsClick(target: HTMLElement): boolean {
  ...
  if (action === "set-accent") {
    updateSettings({ accentID: node?.dataset.accent ?? "noiro" });
