//! # noiro-playback
//!
//! Noiro's engine-owned playback-assets layer: trickplay scrubbing previews, skip-intro/outro markers,
...
//!   `noiro-hive` ed25519 identity, LWW+TTL CRDT, and `TrustStore` gate, so one device's generation
...
pub enum PlaybackError {
    ...
    MalformedDigest,
    #[error(transparent)]
    Hive(#[from] noiro_hive::HiveError),
}
