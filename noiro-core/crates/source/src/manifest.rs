//! The native Noiro addon manifest (`noiro-source/1`): a strict superset of the Stremio manifest. It keeps
...
use noiro_adapters::NuvioRepoManifest;
use noiro_addons::InstalledAddon;
...
pub const NATIVE_SCHEMA: &str = "noiro-source/1";

/// How the engine reaches a source.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(tag = "kind", rename_all = "snake_case")]
pub enum NoiroTransport {
    ...
    /// A federated peer Noiro/hive node.
    Federated { endpoint: String },
    /// A debrid store, addressed by service.
    Debrid { service: noiro_hive::DebridService },
}
...
/// The native Noiro addon manifest.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct NoiroAddonManifest {
    pub schema: String,
    pub id: String,
    pub version: String,
    pub name: String,
...
impl NoiroAddonManifest {
    ...
    /// A bare native (`noiro-source/1`) manifest with all engine hooks off. The public entry point for
    ...
    pub fn native(
        ...
        Self::base(
            ...
            version.into(),
            name.into(),
            SourceKind::NativeNoiro,
            transport,
        )
    }
}

impl From<&InstalledAddon> for NoiroAddonManifest {
...
impl From<&NuvioRepoManifest> for NoiroAddonManifest {
    ...
    fn from(repo: &NuvioRepoManifest) -> Self {
        ...
        let mut out = Self::base(
            ...
            NoiroTransport::NuvioRepo { base_url },
        );
