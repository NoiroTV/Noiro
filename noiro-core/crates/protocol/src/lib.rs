//! # noiro-protocol
//!
//! The Stremio add-on protocol, implemented for Noiro core. This crate is intentionally pure: it
...
//! ecosystem (Torrentio, Cinemeta, AIOStreams, Comet, MediaFusion, ...) work unchanged on Noiro.
//!
...
/// The four core add-on resources Noiro requests by name.
pub mod resources {
