...
//! beyond the essentials) because real add-ons in the wild omit, add, and bend fields; Noiro must
...
///
/// An add-on that lists OTHER add-ons: community add-on collections, and (the payoff) the Noiro
