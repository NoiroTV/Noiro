//! # noiro-hive
//!
//! The Noiro federation/hive public-plane data model. Self-hosted Noiro nodes form a hive that shares
...
pub mod hive_constants {
    ...
    pub const CACHEFACT_PREFIX: &[u8] = b"noiro-cachefact-v1\n";
    /// Domain-separation prefix for a federated torrent-index entry signature.
    pub const TORRENTINDEX_PREFIX: &[u8] = b"noiro-torrentindex-v1\n";
    ...
    pub const ASSETFACT_PREFIX: &[u8] = b"noiro-assetfact-v1\n";
