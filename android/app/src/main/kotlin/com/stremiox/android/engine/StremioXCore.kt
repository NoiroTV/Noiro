...
///
/// The names here are deliberately `stremiox*` and `com.noiro.android.engine.StremioXCore`: the
/// Noiro rebrand keeps all internal identifiers as `stremiox` (the JNI symbol names in
