...
//
// Noiro's Apple app has no Xcode unit-test bundle (verification is build + on-device, per CLAUDE.md),
...
enum TestHouseholdCrypto {
    static let salt = Data("noiro-household-salt-v1".utf8)
    static let info = Data("noiro-household-v1".utf8)
...
enum TestPairingCrypto {
    static let salt = Data("noiro-pairing-salt-v1".utf8)
    static let info = Data("noiro-pairing-v1".utf8)
