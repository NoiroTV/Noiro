...
class VideoSwscale: FrameTransfer {
    ...
    private func setup(format: AVPixelFormat, width: Int32, height: Int32, linesize _: Int32) {
        ...
        if format.osType() != nil {
            ...
            imgConvertCtx = sws_getCachedContext(imgConvertCtx, width, height, self.format, width, height, dstFormat, Int32(bitPattern: SWS_BICUBIC.rawValue), nil, nil, nil)
...
//            imgConvertCtx = sws_getContext(width, height, self.format, width, height, dstFormat, SWS_FAST_BILINEAR, nil, nil, nil)
            ...
            imgConvertCtx = sws_getCachedContext(imgConvertCtx, width, height, self.format, dstWidth, dstHeight, dstFormat, Int32(bitPattern: SWS_FAST_BILINEAR.rawValue), nil, nil, nil)
        }
