...
public protocol KSSubtitleProtocol {
    ...
    func upcomingParts(after time: TimeInterval, limit: Int) -> [SubtitlePart]
}

public extension KSSubtitleProtocol {
    func upcomingParts(after _: TimeInterval, limit _: Int) -> [SubtitlePart] {
        []
    }
}
...
extension KSSubtitle: KSSubtitleProtocol {
    ...
    public func upcomingParts(after time: TimeInterval, limit: Int) -> [SubtitlePart] {
        ...
        return Array(parts.lazy.filter { $0.start > time }.prefix(limit))
    }
}
