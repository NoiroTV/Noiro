...
/// Applied ONCE at the WindowGroup scene root (NoiroApp, macOS only) so it sits ABOVE any sheet
...
private struct MacPlayerChromeHider: NSViewRepresentable {
    func makeNSView(context: Context) -> NSView {
        ...
        DispatchQueue.main.async { [weak view] in
            ...
            // play -> close -> open "Noiro account & sync" crashed; a fresh navigation never did. The
