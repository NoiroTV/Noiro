...
/// the canonical item from any one of them. `imdb`/`tmdb` are what Noiro usually holds (stremio uses
...
struct TraktIDs: Codable, Sendable, Equatable {
    ...
    /// Convenience for the common Noiro case: a stremio imdb id ("tt1234567").
