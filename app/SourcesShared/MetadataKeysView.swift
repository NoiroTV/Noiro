...
/// only enrich recommendations, ratings, and artwork; Noiro works fully without them. The SkipDB key + the
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: Theme.Space.lg) {
                NoiroSettingsPageTitle("Metadata services")
                Text("Optional. Add your own TMDB, MDBList, and fanart.tv keys to enrich recommendations, ratings, and artwork. Nothing here is required, and every key stays in this device's credential store.")
...
struct SkipKeysView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: Theme.Space.lg) {
                NoiroSettingsPageTitle("Skip database")
                Text("Optional. A SkipDB key shares your skip-segment edits with that provider and unlocks its reads. Skip editing works without it, and the key stays in this device's credential store.")
                    .font(Theme.Typography.body)
                    .foregroundStyle(Theme.Palette.textSecondary)
                ...
                Text("Optional. Add a SkipDB-compatible endpoint you operate or trust. The address and key stay on this device.")
