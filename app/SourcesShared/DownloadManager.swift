...
final class DownloadManager: NSObject, ObservableObject {
    ...
    /// The config identifier ("com.elvissalihovic.noiro.downloads.background" vs nil for the default foreground session) is
    ...
    private lazy var backgroundSession: URLSession = {
        let config = URLSessionConfiguration.background(withIdentifier: "com.elvissalihovic.noiro.downloads.background")
    ...
    private lazy var hlsAssetSession: AVAssetDownloadURLSession = {
        let config = URLSessionConfiguration.background(withIdentifier: "com.elvissalihovic.noiro.downloads.hls")
        config.allowsCellularAccess = true
    ...
    private func beginForegroundAssertionIfNeeded(for record: DownloadRecord) {
        ...
        bgTask = UIApplication.shared.beginBackgroundTask(withName: "noiro.download.torrent") { [weak self] in
...
extension DownloadManager: URLSessionDownloadDelegate {
    ...
    nonisolated func urlSession(_ session: URLSession, downloadTask: URLSessionDownloadTask,
        ...
        if let dest {
            ...
            // create failure instead of swallowing it into an opaque -3000. Helper contributed by a Noiro
