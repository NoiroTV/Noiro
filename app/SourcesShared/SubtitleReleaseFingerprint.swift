...
/// Content-key + release-fingerprint helpers for Noiro's community-subtitle system.
///
/// The pool at `vortexo.app/api/noiro/v1/edge/subtitles` keys everything on a `content_key` (the title/episode) plus, for the
