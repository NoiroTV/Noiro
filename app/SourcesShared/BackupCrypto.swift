...
/// device to device inside the pairing QR. The Noiro sync service therefore only ever stores
...
enum BackupCrypto {
    ...
    /// A fresh random 256-bit key (minted when a new Noiro account is created).
