...
/// channel (the entitlement-protected Vortexo Library); "Later" dismisses for this build this launch.
///
    ...
    var body: some View {
        VStack(spacing: Theme.Space.md) {
            ...
            VStack(spacing: Theme.Space.sm) {
                ...
                // Use the app's own dark-surface focus style. The system `.bordered` treatment combined
                // the light theme tint with a white tvOS button fill, leaving "Later" invisible.
                Button { finish() } label: {
