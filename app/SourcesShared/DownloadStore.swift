...
///
/// This store is intentionally NOT synced (no Noiro-account / E2E write): a download is a physical file
...
final class DownloadStore: ObservableObject {
    ...
    /// root is the correct target. H20-FIX contributed by a Noiro subreddit user (credited in the changelog).
