...
actor TraktAuth {
    ...
    private let accessAccount = "noiro.trakt.accessToken"
    private let refreshAccount = "noiro.trakt.refreshToken"
    private let expiryAccount = "noiro.trakt.expiresAt"   // unix epoch seconds, stored as a string
