        ...
        ScrollView {
            VStack(alignment: .leading, spacing: Theme.Space.lg) {
                ...
                card {
                    ...
                    Text("Open Account & sync and sign in with your Stremio account. Noiro runs on the same engine, so your add-ons, library, and Continue Watching come across automatically, and stay in sync across your devices. Nothing to export or copy by hand.")
