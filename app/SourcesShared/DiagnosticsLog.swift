...
enum DiagnosticsLog {
    private static let queue = DispatchQueue(label: "noiro.diaglog", qos: .utility)
    ...
    /// Mirror into the EXPORTABLE probe log (Caches/noiro-diag.log). The in-app log export serves ONLY
