...
final class VXTrailerProxy {
    ...
    private let queue = DispatchQueue(label: "com.elvissalihovic.noiro.vxtrailerproxy")
    ...
    private let listenerQueue = DispatchQueue(label: "com.elvissalihovic.noiro.vxtrailerproxy.listener")
