...
final class CommunityAddonStore: ObservableObject {
    ...
    // `nonisolated`: an immutable Sendable constant, read by the nonisolated `fetch()`.
    nonisolated private static let url = URL(string: "https://api.strem.io/addonscollection.json")!
