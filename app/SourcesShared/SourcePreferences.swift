...
final class SourcePreferences: ObservableObject, SourcePrefsReading {
    ...
    private static let orderKey      = "noiro.streaming.sourceTypeOrder"
    private static let addonOrderKey = "noiro.streaming.useAddonOrder"
    static let excludeKey            = "noiro.streaming.excludeKeywords"
    static let includeKey            = "noiro.streaming.includeKeywords"
    static let safetyKey             = "noiro.streaming.safetyMode"
    static let hideDeadKey           = "noiro.streaming.hideDeadTorrents"
    static let instantOnlyKey        = "noiro.streaming.instantOnly"
    static let maxResolutionKey      = "noiro.streaming.maxResolution"
    static let maxFileSizeKey        = "noiro.streaming.maxFileSizeGB"
    static let hdrOnlyKey            = "noiro.streaming.hdrOnly"
    static let excludeAV1Key         = "noiro.streaming.excludeAV1"
    static let defaultSortKey        = "noiro.streaming.defaultSourceSort"
    static let regexKey              = "noiro.streaming.keywordsAreRegex"
