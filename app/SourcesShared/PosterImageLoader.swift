...
enum PosterImageLoader {
    ...
    private static let cache: URLCache = {
        ...
        return URLCache(memoryCapacity: memoryCapacity, diskCapacity: diskCapacity, diskPath: "noiro-images")
    }()
    ...
    static func configureSharedCache() {
        _ = session
        VXProbe.log("poster", "configureSharedCache built dedicated poster cache memory=64MB disk=512MB diskPath=noiro-images")
    }
