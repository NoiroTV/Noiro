    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: Theme.Space.lg) {
                NoiroSettingsPageTitle("Streaming Server")
                Text("Use the server embedded on this device, or point Noiro at a remote / dedicated Stremio server (for example one you run at home).")
