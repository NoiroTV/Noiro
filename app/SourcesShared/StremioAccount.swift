...
final class StremioAccount: ObservableObject {
    ...
    private let emailKey = "noiro.email"
    private let log = Logger(subsystem: "com.elvissalihovic.noiro.app", category: "account")
    ...
    private static func displayEmail() -> String? {
        ...
        return UserDefaults.standard.string(forKey: "noiro.email")
    }
