...
/// Sheet for submitting or correcting skip segments to the keyless vortexo.app/api/noiro/v1/edge/skip worker. Opened from
...
struct SkipDBSubmitView: View {
    ...
    private var submitSection: some View {
        Section {
            ...
            Text("Submissions feed Noiro's own skip database and help everyone on the title.")
        }
    }
