...
///
/// This is the first step of the 0.3.9 link resolver (design: `noiro-yt-twitch-resolver-design.md`,
...
enum StreamLinkKind: Equatable {
    ...
    /// remote resolver (`vortexo.app/api/noiro/v1/edge/trailer/yt/{id}`), the same path the Trailer button uses.
...
enum LinkResolver {
    private static let log = Logger(subsystem: "com.elvissalihovic.noiro.app", category: "linkresolver")
