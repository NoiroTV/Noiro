...
struct MPVProperty {
    ...
    /// Synthetic subtitle signal whose text is already presentation-ready (for example a progressively
    /// translated KSPlayer external cue). TVPlayerView displays it directly and must not translate it again.
    static let presentedSubText = "stremiox-presented-sub-text"
    static let aid = "aid"
    static let sid = "sid"
