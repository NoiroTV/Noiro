...
enum HDRDisplayMode {
    private static let log = Logger(subsystem: "com.elvissalihovic.noiro.app", category: "hdr")
    ...
    static let userHintNotification = Notification.Name("noiro.hdr.userHint")
    ...
    /// NoiroRemuxHLSServer compiles for iOS and macOS too and reads `isSwitchSettled` there; those platforms
