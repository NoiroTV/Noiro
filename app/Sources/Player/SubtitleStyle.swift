...
enum SubtitleStyle {
    ...
    enum Key {
        static let font = "noiro.sub.font"
        static let size = "noiro.sub.size"
        static let sizeScale = "noiro.sub.sizeScale"
        static let color = "noiro.sub.color"
        static let background = "noiro.sub.background"
    }
    ...
    static let colors: [(id: String, label: String, hex: String)] = [
        ("white", "White", "#FFFFFF"), ("yellow", "Yellow", "#FFFF00"), ("orange", "Orange", "#FF9500"),
        ("soft", "Soft", "#F2F2F2"),
    ]
