...
//!
//! Kotlin entry points (all on `com.noiro.android.engine.StremioXCore`):
...
#[no_mangle]
pub extern "system" fn Java_com_noiro_android_engine_StremioXCore_nativeSchemaVersion(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_com_noiro_android_engine_StremioXCore_nativeInit<'local>(
...
#[no_mangle]
pub extern "system" fn Java_com_noiro_android_engine_StremioXCore_nativeDispatch<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_noiro_android_engine_StremioXCore_nativeGetState<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
