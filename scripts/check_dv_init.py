#!/usr/bin/env python3
"""Offline verifier for the Noiro DV remux HLS artifacts (b172 audit tooling).
...
Init segment checks (ftyp+moov produced by NoiroMKVRemuxStream / served as /init.mp4):
