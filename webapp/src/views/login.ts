...
// The Noiro account screen for the webapp, ported from the website's login controller (the same state
...
function render(): void {
  ...
  hostEl.innerHTML = `
    <div class="auth-screen">
      <p class="t-eyebrow">Noiro account</p>
      <h1 class="t-screen auth-title">Your sync, end to end encrypted.</h1>
      <p class="t-body auth-lead">Your profiles, settings, library, and history on every device. Your password is the key, so no Noiro server can ever read your data.</p>
      ${stepMarkup()}
