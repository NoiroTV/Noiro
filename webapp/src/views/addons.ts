...
export function renderAddons(host: HTMLElement, addons: Addon[], onChange: () => void): void {
  ...
  host.innerHTML = `
    <div class="addons">
      ...
      <p class="addon-intro">
        Noiro web plays two kinds of source: <strong>direct HTTPS</strong> streams and
      ...
      <p class="addon-intro muted">
        ...
        Noiro, so paste the personal manifest URL its configure page gives you into the field below.
      </p>
