// Archived household preview — the orchestration + per-device consent layer behind
...
const FAM_API = "https://vortexo.app/api/noiro/v1/edge/legacy-household";
...
function consentKey(channel: Channel, accountId: string): string {
  return `noiro.household.consent.${channel}.${accountId}`;
}
