// Archived web-preview adapter. Noiro releases may use official direct trailer
// URLs only; the inherited trailer proxy is intentionally disabled pending the
// rights-reviewed implementation.
//
...
//
// Everything here is FAIL-SOFT: while the adapter is disabled, the caller hides the
