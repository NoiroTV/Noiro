...
const PT = JSON.stringify({ noiro: { addons: ["a", "b"] }, version: 7 });
...
test("Swift/CryptoKit-sealed vector opens here (cross-surface byte format pinned)", async () => {
  // Fixed regression vector sealed with the Noiro AAD/framing contract (AES-GCM + additionalData,
  // iv||ct||tag, standard base64) for (dataKey, "acct_12345", 1720000000042, PT). If the
  ...
  const blob = "v2.AAECAwQFBgcICQoLyk+YhCRAopw77yfYnk7J1QeoIkbNX+Y9gp10Ffhqw/4OuAMa4dkyQ5ThlVY2DPcwoM0sq7Ez6sfB6g==";
